...
export default function PrivacyPolicyContent({ homeHref = "/" }: { homeHref?: string }) {
  return (
          ...
          <div className="prose-valisen mt-10 space-y-10 text-[15px] leading-[1.75] text-ink-secondary">
            ...
            <Section title="1. Who We Are">
              <p>
                ...
                operating at{" "}
                <Link href={homeHref} className="text-teal hover:underline">
            ...
            <Section title="Healthcare Provider Referrals">
              <p>With patient authorization, referring professionals may submit provider and patient contact information, a general referral reason, language and therapist preferences, and brief coordination notes. Valisen uses these details to review the referral, contact the patient and coordinate care. A versioned authorization statement and submission time are recorded.</p>
              <p>New provider referrals are delivered by email to info@valisenmentalhealth.com for authorized clinic staff to review and coordinate patient contact. They are not saved in the website CRM or referral database, or sent to advertising services, analytics or marketing reporting exports. Email providers process and retain the referral email as part of delivering and maintaining the clinic mailbox. We also send the referring provider a separate acknowledgement containing a reference number and general next steps, without patient details. Please do not submit health card numbers or detailed clinical records through this form. Referral submission does not authorize clinical updates to the referring provider; any such disclosure requires separate authorization where applicable.</p>
              <p>Provider referral records follow the administrative intake retention policy described above. Contact our Privacy Officer with access, correction or consent questions. The referral page records only non-sensitive interaction events, such as opening the page or completing submission; form contents are excluded.</p>
            </Section>
