        ...
        <div className="container-v max-w-[760px]">
          ...
          <div className="prose-valisen mt-10 space-y-10 text-[15px] leading-[1.75] text-ink-secondary">
            ...
            <Section title="Healthcare Provider Referrals">
              ...
              <p>Provider referrals are stored separately in our access-controlled operations database and are available only to authorized administrative staff through the private referral inbox. They are not sent to advertising services, analytics, email notifications or marketing reporting exports. Please do not submit health card numbers or detailed clinical records through this form. Referral submission does not authorize clinical updates to the referring provider; any such disclosure requires separate authorization where applicable.</p>
