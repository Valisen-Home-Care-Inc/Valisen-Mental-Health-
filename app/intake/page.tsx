...
export const metadata = {
  ...
  description:
    "A simple intake to help us understand what you're looking for in a therapist.",
};
      ...
      <section className="py-12 md:py-20">
        <div className="container-v max-w-[560px]">
          <div className="mb-8 text-center">
            <span className="badge-outline-teal mb-5">GET IN TOUCH</span>
            ...
            <p className="mx-auto mt-4 max-w-[480px] text-[15px] leading-[1.6] text-ink-secondary">
              Fill in the form below and our team will be in touch to help you get started.
            </p>
          </div>
