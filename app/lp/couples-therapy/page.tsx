...
const config = getPaidSearchLandingPage("couples-therapy");
const canonical = "https://valisenmentalhealth.com/lp/couples-therapy";
...
export default function CouplesTherapyLandingPage() {
