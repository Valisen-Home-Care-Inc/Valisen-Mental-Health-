...
const config = getPaidSearchLandingPage("depression-therapy");
const canonical = "https://valisenmentalhealth.com/lp/depression-therapy";
...
export default function DepressionTherapyLandingPage() {
