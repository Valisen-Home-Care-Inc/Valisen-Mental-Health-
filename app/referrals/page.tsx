    ...
    <main id="referrals-main">
      ...
      <section id="referral-therapists" className={`container-v ${styles.section}`}>
        ...
        <div className={styles.clinicians}>{clinicians.map(t => <article key={t.slug} className={styles.clinician}>
          <div className={styles.clinicianTop}>{t.photo && <Image src={t.photo} alt={t.name} width={90} height={108} sizes="90px" style={{ objectPosition: t.photoPosition || "center 25%" }} />}<div><h3>{t.name}</h3><p>{t.credentials}</p></div></div>
