...
export const paidSearchConcepts: PaidSearchConcept[] = [
  {
    ...
    headline: "Less time in your head.", emphasis: "More room for your life.",
    introduction: "The overthinking. The constant what-ifs. The feeling that you can never quite switch off. Work with a therapist who understands anxiety, with space to be heard and practical tools to move forward.",
    cta: "Find my anxiety therapist",
  ...
  },
  {
    ...
    introduction: "When everyday things take more effort and the things you used to enjoy feel far away, you deserve support that meets you where you are. Talk with a therapist about the heaviness, at a pace you can manage.",
    cta: "Find support for depression",
  ...
  },
  {
    ...
    introduction: "Looking for therapy with a clear direction? Work with a therapist who uses CBT to explore the connection between thoughts, feelings, and actions—and build practical strategies around your goals.",
    cta: "Find a CBT therapist",
    ...
    therapists: [timPractical, meryemAnxiety], proof: ["CBT + collaboration", "A practical approach shaped around you"],
  ...
  },
  {
    ...
    headline: "Less going in circles.", emphasis: "More understanding each other.",
    ...
    cta: "Find our couples therapist",
    ...
    therapists: [{ slug: "wilfred-bengnwi", heading: "Relationship repair is a central part of his work.", description: "Wilfred brings a relational, attachment-informed approach to couples therapy. His work focuses on conflict cycles, communication, trust, and the emotional patterns underneath recurring relationship struggles.", reasons: ["4+ years specializing in couples therapy", "Attachment-informed & repair-focused", "Communication, trust & emotional infidelity"] }, { ...ryannPatterns, heading: "Understand what each of you brings to the pattern.", description: "Ryann works with adult couples and individuals on relationship challenges, boundaries, people-pleasing, and communication. Her curious style makes room for understanding and practical tools.", reasons: ["Works with adult couples", "Boundaries & communication", "Virtual & telephone sessions"] }],
    proof: ["4+ years", "Wilfred’s focus on couples therapy"],
    faqs: [{ question: "Do we both need to join the consultation?", answer: "Let the team know whether one or both of you plan to join. We can explain the next step and help you discuss fit, scheduling, and what couples sessions involve." }, { question: "Can we talk about infidelity or broken trust?", answer: "Wilfred’s listed areas of work include relationship repair, emotional infidelity, and attachment injuries. You can ask about his approach without sharing the details in this form." }],
  ...
  },
  {
    ...
    cta: "Find a therapist to talk to",
  ...
  },
  {
    ...
    introduction: "Meet a regulated therapist without fitting a commute into your day. Get to know the person, understand the fees, and start with a free phone consultation before choosing your next step.",
    ...
    proof: ["Across Ontario", "A local clinic, without the commute"],
  ...
  },
  {
    ...
    headline: "Know who you’re talking to.", emphasis: "Feel good about the next step.",
    introduction: "Real clinicians. Clear qualifications. A conversation before you commit. Meet Registered Psychotherapists with different strengths and choose the kind of support you want to explore.",
    cta: "Meet my next therapist",
  ...
  },
  {
    ...
    headline: "Ready to find your therapist?", emphasis: "Start with one conversation.",
    introduction: "You’re already thinking about getting support. Make the next step simple: a free, 20-minute phone consultation to talk about fit, ask your questions, and understand your options.",
    cta: "Choose my consultation time",
    ...
    approach: [
      { title: "Tell us what you’re looking for", description: "Share a little about the support you want, without having to give a detailed personal history." },
  ...
  },
  {
    ...
    introduction: "Family expectations. Life between cultures. The feelings that are difficult to translate. Speak with Dayong Quan in Mandarin or English, with space for your language, your context, and your experience.",
    cta: "Ask about therapy with Dayong",
    ...
    recognition: ["Explaining family expectations while trying to explain your feelings.", "Navigating immigration, belonging, or life between cultures.", "Wanting to speak naturally, without translating every detail first."],
    ...
    approach: [
      ...
      { title: "Make room for your context", description: "Discuss family roles, cultural expectations, migration, identity, and major life changes." },
    ...
    faqs: [{ question: "Can my therapy sessions be in Mandarin?", answer: "Yes. Dayong offers psychotherapy in both Mandarin and English. Tell us you are looking for Mandarin therapy when arranging your consultation so that preference is clear from the start." }, { question: "Can we discuss cultural or immigration-related pressure?", answer: "Yes. Dayong’s listed work includes cultural adjustment, immigration stress, family expectations, belonging, and major life transitions." }],
  ...
  },
  {
    ...
    introduction: "You deserve a space where language, culture, and the experiences that shaped you belong in the conversation. Meryem Ibrahim offers compassionate, culturally responsive therapy in Arabic and English.",
    cta: "Ask about therapy with Meryem",
    ...
    recognition: ["Looking for support that makes room for culture, faith, and identity.", "Carrying the pressure of change, migration, or family expectations.", "Wanting to express yourself without searching for the English words."],
    ...
    approach: [
      ...
      { title: "Bring your whole context", description: "Make space for culture, identity, faith, grief, trauma, and the impact of life changes." },
    ...
    faqs: [{ question: "Can therapy be entirely in Arabic?", answer: "Yes. Meryem provides psychotherapy in Arabic and English. State your language preference when arranging the consultation so the team can help with the next step." }, { question: "What does RP (Qualifying) mean?", answer: "Meryem is a Registered Psychotherapist in the Qualifying category. Her designation is shown clearly so you can ask questions about her practice and confirm whether your benefits plan covers sessions with an RP (Qualifying)." }],
  ...
  },
  {
    ...
    cta: "Ask about therapy with Ryann",
    ...
    proof: ["A specific fit", "Perfectionism is part of Ryann’s practice"],
  ...
  },
  {
    ...
    cta: "Explore trauma-informed support",
    ...
    therapists: [{ ...timPractical, heading: "Experience with trauma and practical stabilization.", description: "Tim draws from EMDR, CBT, DBT, and solution-focused approaches. His trauma work includes practical stabilization strategies and support for people processing difficult experiences.", reasons: ["EMDR-informed trauma work", "Practical stabilization & coping", "20+ years supporting clients"] }, { ...meryemAnxiety, heading: "Choice, pacing, and a compassionate understanding.", description: "Meryem offers trauma-informed, culturally responsive care for adults. Her approach prioritizes a non-judgmental space, client choice, and the pace at which you feel ready to work.", reasons: ["Trauma-informed & culturally responsive", "Attention to choice & pacing", "English & Arabic sessions"] }],
    ...
    suggestedKeywords: ["trauma informed therapist Ontario", "online trauma therapy Ontario", "EMDR therapist Ontario"],
  },
];
