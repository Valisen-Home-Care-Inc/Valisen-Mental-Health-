...
export const REFERRAL_CONSENT_VERSION = "2026-09-18";
export const REFERRAL_CONSENT = "I confirm that I am authorized to share this information and have the patient's consent for Valisen Mental Health to use it to coordinate this referral and contact the patient. I understand that submitting a referral does not book an appointment or authorize disclosure of clinical information back to me.";
export const REFERRAL_ACTION = "provider_referral";
// Connect the approved public PDF here when available. Do not use a dummy URL.
export const REFERRAL_GUIDE_URL: string | null = null;
